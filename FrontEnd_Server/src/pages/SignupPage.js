    ...
    return (
        <div className={style.signup_total}>
            ...
            <form onSubmit={handleSubmit}>
                <div className={style.userbox} style={{ display: "flex", alignItems: "center", marginBottom: "30px" }}>
                <input className={style.first} type="text" name="" required="" onChange={onChangeUserid}/>
                <label>ID</label>
                <button className={style.confirmbtn} onClick={idChecking}>중복확인</button>
                </div>
                <p
                  className={` ${
                ...
                <div className={style.userbox} style={{ marginBottom: "30px", marginTop: "40px"  }}>
                <input className={style.first} type="text" name="" required="" onChange={onChangeName}/>
                <label>Username</label>
                </div>
                <div className={style.userbox} style={{ marginBottom: "30px" }}>
                <input className={style.first} type="email" name="" required="" onChange={onChangeEmail}/>
                <label>Email</label>
                </div>
                <div className={style.userbox} style={{ marginBottom: "30px" }}>
                <input className={style.second} type="password" name="" required="" onChange={onChangePassword}/>
                <label>Password</label>
                </div>
                <div className={style.userbox} style={{ marginBottom: "10px" }}>
                <input className={style.second} type="password" name="" required="" onChange={onChangeConfirmPassword}/>
